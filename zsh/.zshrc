...
alias vme="python ~/docfiles/script/switch_nvim.py 178me ;nvim"
alias vla="python ~/docfiles/script/switch_nvim.py lazy ;nvim"
alias adbbb="python ~/docfiles/script/adb_connect.py"
# ranger
